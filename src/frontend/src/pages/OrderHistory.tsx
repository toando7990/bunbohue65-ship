...
export default function OrderHistory() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    ...
    // thoáng qua ngay sau khi danh sách đã tải thành công (xem lý do bên dưới).
  ...
  // danh sách 29 đơn đã hiện đúng sẽ bị thay bằng "Không tải được đơn hàng"
  // chỉ vì 1 lần refetch nền chập chờn, dù dữ liệu đã có sẵn không cần vứt
  // bỏ. Đây chính là lỗi trong ảnh chụp màn hình: danh sách hiện đúng vài
  // giây rồi bị đổi thành lỗi.
