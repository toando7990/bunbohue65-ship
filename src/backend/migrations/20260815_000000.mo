...
// Stable upgrade: thêm stable field `otpRecords` (Map<Email, OtpRecord>) cho
// domain xác nhận email (OTP). Không có dữ liệu OTP nào trước đây, nên NewActor
// khởi tạo `otpRecords` là Map rỗng.
//
// OldActor = NewActor của migration 20260814_000000.mo (10 stable fields, đã có
// accessControlShuttle và MenuItem dùng `image : Blob`). NewActor = cùng 10
// stable fields + `otpRecords` rỗng.
module {
